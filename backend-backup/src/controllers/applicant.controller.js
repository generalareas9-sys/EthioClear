 ...
 *
 * Note: applicants do not receive certificate download access.
 * When a certificate is issued, they receive an in-app notification
 * (created by certificate.controller.generateCertificate) containing
 * the certificate number and public verification URL.
 */
 ...
 * Lists applications belonging to the logged-in applicant, paginated.
 */
 ...
 *
 * Does NOT return certificate data. When the application status is
 * 'certificate_issued', the applicant sees that status and is
 * directed to the Certificate Verification page via the in-app
 * notification they received at issuance time.
 */
 ...
 * Uploads one supporting document for an application the applicant owns.
 */
